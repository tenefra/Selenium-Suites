...
public class SignUp_InvalidEmail {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.cssSelector("input[id='dwfrm_profile_customer_email")).sendKeys("invalidusername");
		driver.findElement(By.cssSelector("input[id='dwfrm_profile_customer_emailconfirm")).sendKeys("invalidusername");

...
public class SignUp_PWNoMatch {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.cssSelector("input[id='dwfrm_profile_customer_emailconfirm")).sendKeys("validusername@gmail.com");
		...
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/div[1]/form[1]/fieldset[2]/div[4]/div[1]/input[1]")).sendKeys("sdfjkh123$$");
